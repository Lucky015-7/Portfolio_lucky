...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // These keys now match your EmailJS template screenshot exactly
      await emailjs.send(
        "service_pc6ch2s", // Ensure this is your current Service ID
        "template_vymn1vh", // Ensure this is your current Template ID
        {
          name: formData.name,       // Matches {{name}}
          email: formData.email,     // Matches {{email}} in Reply-To
          message: formData.message, // Matches {{message}}
          title: "Portfolio Inquiry", // Matches {{title}} in Subject
          to_email: "lakhitha015@gmail.com",
        },
        "CxU0hihyWpVMz5WuB" // Ensure this is your Public Key
      );
